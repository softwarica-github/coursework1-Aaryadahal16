...
project_text = ttk.Label(first_frame, text="Web Enumeration Tool", font=("Helvetica", 30), foreground="#023e8a", background="#ffafcc")
project_text.grid(row=0, column=3, columnspan=3, pady=20, padx=40)

by_text = ttk.Label(first_frame, text="by", font=("Helvetica", 25), foreground="#023e8a", background="#ffafcc")
by_text.grid(row=1, column=3, columnspan=3, pady=10, padx=10)

name_text = ttk.Label(first_frame, text="Aarya Dahal", font=("Helvetica", 35), foreground="#023e8a", background="#ffafcc")
name_text.grid(row=2, column=3, columnspan=3, pady=(10,150), padx=10 ,sticky='n')

directory_scan_button = tk.Button(first_frame, text="Directory Scan", command=directory_scan, font=("Helvetica", 13), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="#1985a1")
directory_scan_button.grid(row=3, column=3, columnspan=3,sticky="s",  pady=20)
directory_scan_button.config(width=14)

gather_info_button = tk.Button(first_frame, text="Get Info", command=gather_info, font=("Helvetica", 13), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="#c5c3c6")
gather_info_button.grid(row=4, column=3, columnspan=3,sticky="s",  pady=20)
gather_info_button.config(width=14)

exit_button = tk.Button(first_frame, text="Exit", command=root.quit, font=("Helvetica", 13), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
exit_button.grid(row=5, column=3, columnspan=3, sticky="s",  pady=20)
...
directory_scan_frame = tk.Frame(root, bg="#ffafcc")

sign_up_text = ttk.Label(directory_scan_frame, text="Directory Scan", font=("Travelast", 20), foreground="#023e8a", background="#ffafcc")
...
ip_address_label = tk.Label(directory_scan_frame, text="Enter a URL", font=("Helvetica", 12), foreground="#023e8a", background="#ffafcc")
ip_address_entry = ttk.Entry(directory_scan_frame, width=35, font=("Helvetica", 12), foreground="#ffafcc", style="Round.TEntry", background='gray')
...
browse_button = tk.Button(directory_scan_frame, text="Browse", command=browse_file, font=("Helvetica", 12), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
browse_button.grid(row=1, column=3,padx=(0,30),pady=20,sticky="e")
browse_button.config(width=8)

start_button = tk.Button(directory_scan_frame, text="Start", command=lambda:check_directories(file_path), font=("Helvetica", 12), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
...
search_entry = ttk.Entry(search_container, width=20, font=("Helvetica", 12), foreground="black", style="Round.TEntry", background='#023e8a')
...
back_button = tk.Button(directory_scan_frame, text="Back", command=back_to_main, font=("Helvetica", 12), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
...
info_frame = tk.Frame(root, bg="#ffafcc")

log_in_text = ttk.Label(info_frame, text="Get Informations", font=("Travelast", 25), foreground="#023e8a", background="#ffafcc")
log_in_text.grid(row=0, column=1, columnspan=4, pady=30, padx=50)



'''sign up frame ---- back button '''
back_button = tk.Button(info_frame, text="Back", command=back_to_main, font=("Helvetica", 12), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
back_button.grid(row=6, column=1, sticky="w",padx=10,pady=50)
back_button.config(width=8)

url_label = tk.Label(info_frame, text="Enter a URL", font=("Helvetica", 12), foreground="#023e8a", background="#ffafcc")
url_entry = ttk.Entry(info_frame, width=35, font=("Helvetica", 12), foreground="#ffafcc", style="Round.TEntry", background='gray')
...
start_button = tk.Button(info_frame, text="Start", command=lambda:start_gather_info(), font=("Helvetica", 12), background="#00b4d8", 
                        foreground="#023e8a", relief="raised", bd=3, activebackground="#144552",activeforeground="red")
